...
@Software: PyCharm
@File: 4.4_ImplementNonLinearSVM.py
@Time: 2019/1/6 下午1:31
@Overview: We will apply a non-linear kernel to split a dataset
"""
import numpy as np
...
plt.title('Gaissian SVM Results on Iris Data')
